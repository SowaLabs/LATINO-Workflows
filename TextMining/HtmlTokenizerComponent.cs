...
namespace Latino.Workflows.WebMining
{
    ...
    */
    ...
    {
        private static Set<string> mTagSkipList 
        ...
        private static Set<string> mTagKeepList 
        ...
        private Set<string> mAdditionalSkipTags
            = new Set<string>("form,fieldset,legend,label,input,button,select,datalist,optgroup,option,textarea,keygen,output,progress,meter,details,summary,menuitem,menu,img,iframe,embed,object,param,video,audio,source,track,canvas,map,area,svg,math,nav,aside,header,footer,address".Split(','));
